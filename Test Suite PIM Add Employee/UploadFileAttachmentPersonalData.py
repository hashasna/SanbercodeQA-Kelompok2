...
class TestLogin(unittest.TestCase):
    ...
    def test_upload_file_attachment_personal_data(self):
        # steps
        driver = self.browser #buka web browser
        time.sleep(5)
        driver.get("http://opensource-demo.orangehrmlive.com/") # buka situs
        self.browser.maximize_window() #max window
        time.sleep(3)
        ...
        time.sleep(3)
        driver.execute_script("window.scrollTo(100,document.body.scrollHeight);") #scroll page
        time.sleep(3)
        ...
        time.sleep(3)
        print("Success upload Gambar in attachment")
